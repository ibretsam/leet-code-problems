...
You are also given a 2D array meetings of size n where, meetings[i] = [start_i, end_i] represents the starting and ending days of 
meeting i (inclusive).
...
print(countDays(57, [[3,49],[23,44],[21,56],[26,55],[23,52],[2,9],[1,48],[3,31]])) # 1